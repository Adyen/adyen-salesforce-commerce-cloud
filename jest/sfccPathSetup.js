...
jest.mock('*/cartridge/controllers/middlewares/adyen/splitPayments', () => {
  return require('../src/cartridges/int_adyen_SFRA/cartridge/controllers/middlewares/adyen/splitPayments');
}, {virtual: true});
