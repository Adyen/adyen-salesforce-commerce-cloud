...
const billing = require('int_adyen_SFRA/checkout/billing');
// ### Custom Adyen cartridge start ###
const adyenCheckout = require('int_adyen_SFRA/adyenCheckout');
    ...
    var members = {
      ...
      updateStage: function () {
        ...
        if (stage === 'customer') {
          ...
          // pass terms and conditions flag data to api call
          var termsAndConditionsForm = $('#termsAndConditionsForm').serialize();
          $.ajax({
            url: $('.place-order').data('action'),
            method: 'POST',
            data: termsAndConditionsForm,
            success: function (data) {
