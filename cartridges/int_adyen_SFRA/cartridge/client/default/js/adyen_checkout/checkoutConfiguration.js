...
function getAmazonpayConfig() {
  return {
    ...
    addressDetails: {
      name: "".concat(document.querySelector('#shippingFirstNamedefault').value, " ").concat(document.querySelector('#shippingLastNamedefault').value),
      ...
      stateOrRegion: document.querySelector('#shippingAddressCitydefault').value,
