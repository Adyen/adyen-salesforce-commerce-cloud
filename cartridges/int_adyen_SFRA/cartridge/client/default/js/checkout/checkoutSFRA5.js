...
var billing = require('./billing'); // ### BEGIN Custom Adyen cartridge ###


var adyenCheckout = require('../adyenCheckout'); // ### END Custom Adyen cartridge ###
          ...
          $.ajax({
            ...
            success: function success(data) {
              ...
              if (data.error) {
                ...
                adyenCheckout.actionHandler(data.adyenAction); // ### END Custom Adyen cartridge ###
              } else {
