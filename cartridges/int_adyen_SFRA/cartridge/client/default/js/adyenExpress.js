...
function _mountPayPalComponent() {
  _mountPayPalComponent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var session, sessionData, shippingMethods, shippingMethodsData, environment, paypalConfig, checkout, paypalComponent;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            paypalComponent = checkout.create('paypal', paypalConfig);
