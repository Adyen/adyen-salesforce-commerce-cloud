...
server.prepend(
    ...
    function (req, res, next) {
        // Logger.getLogger('Adyen').error(JSON.stringify(req.form.brandCode));
        // if(req.form.brandCode === 'paypal') {
        //     var viewData = res.getViewData();
        //     Logger.getLogger('Adyen').error('view data is ... ' + JSON.stringify(viewData));
        //     viewData.adyen = {test: 'test'};
...
//     function (req, res, next) {
//         if(req.form.brandCode === 'paypal') {
//             res.json({clear: 'clear'});
//             return next();
//         }
        // var Transaction = require('dw/system/Transaction');
        // Logger.getLogger('Adyen').error('inside append');
        // if(req.form.brandCode === 'paypal') {
        //
        ...
        //     });
        //
        //     session.privacy.test = JSON.stringify(result);
        //     Logger.getLogger('Adyen').error(JSON.stringify(session.privacy.test));
        //     res.json(result);
        //     return next();
    // }
// );
