...
var constants = require("*/cartridge/adyenConstants/constants"); // ### Custom Adyen cartridge start ###
...
var adyenSaveCreditCard = require("*/cartridge/scripts/adyenSaveCreditCard"); // ### Custom Adyen cartridge end ###
...
function Delete() {
  ...
  paymentForm.handleAction({
    ...
    error: function () {// @TODO When could this happen
    }
  });
  response.redirect(URLUtils.https('PaymentInstruments-List'));
} // ### Custom Adyen cartridge end ###
