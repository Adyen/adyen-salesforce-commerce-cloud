...
var Cart = app.getModel('Cart'); // ### Custom Adyen cartridge start ###

var AdyenController = require("int_adyen_controllers/cartridge/controllers/Adyen"); // ### Custom Adyen cartridge end ###
...
function start(context) {
  var cart = Cart.get(); // Checks whether all payment methods are still applicable. Recalculates all existing non-gift certificate payment
