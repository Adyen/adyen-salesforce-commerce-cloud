...
function showConfirmation() {
  try {
    ...
    var order = OrderMgr.getOrder(merchantReference); // if the payment is authorized, we can navigate to order confirm
...
function paymentsDetails() {
  try {
    ...
    if (paymentsDetailsResponse.merchantReference !== 'recurringPayment-account') {
      ...
      _response.redirectUrl = URLUtils.url('Adyen-ShowConfirmation', 'merchantReference', _response.merchantReference, 'signature', signature).toString();
    }
